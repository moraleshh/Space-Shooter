...
win = font2.render("you win", True, (255,200,210))
lose = font2.render("you lose!", True, (255,200,210))
...
while run:
    ...
    if not finish:
        ...
        text_lose = font2.render("Mise: " + str(lost), 1, (225,225,225))
        ...
        #text_lose = font2.render("Mised: " + str(score), 1, (255, 255, 255))
        #window.blit(text_lose, (10, 50))
